      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <article className="bg-white border border-vintage-grisClaro rounded-2xl p-8 shadow-sm flex flex-col justify-between hover:border-vintage-verde/50 transition-all duration-300 group">
          <div className="space-y-4">
            <div className="inline-block p-3 bg-vintage-verde/10 rounded-xl transition-transform">
          ...
          <div className="pt-6">
            <a
              ...
              className="inline-flex items-center justify-center space-x-2 w-full py-3.5 px-4 bg-vintage-verde hover:bg-vintage-cafe text-white font-bold rounded-xl text-xs uppercase tracking-widest shadow transition-colors duration-300"
            >
